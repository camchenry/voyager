function love.conf(t)
    t.identity = 'voyager_server'                   -- The name of the save directory (string)
    t.version = "0.9.1"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)

    t.window.title = "Voyager_Server"        -- The window title (string)
...
config = {
    gameTitle = "Voyager_Server",
    windowTitle = "Voyager_Server",
    ...
    fontBold = 'fonts/FiraSans-Bold.otf',
    fontLight = 'fonts/FiraSans-Light.otf',
}
